  ...
  <view class="main">
    <view v-if="isLoading === false">
        ...
        <u-row>
          ...
          <u-col span="4">
            ...
            <view class="pingfen" style="display: flex;">
              <start :disabled="true" :disabledColor="'orange'" active-color="#eaa12e" size="18" v-model="facility.rate"></start>
      ...
      <view>
        ...
        <view class="number">
                  <u-text size="35" align="left" color="black" font-wigth="bold" :text="'Evaluations'"></u-text>
        </view>
    ...
    <view class="yonghu" v-for="(item,index) in pro">
      ...
      <view class="pingfen" style="display: flex;">
        <start :count="item.evaluation.score" :disabled="true" :disabledColor="'orange'" active-color="#ff0000" size="18" v-model="item.evaluation.score"></start>
        <view style="font-size: 10px;margin-left: 10px; color: #808080;">
          {{item.content}}
        </view>
      </view>
      <view style="margin-top: 5px;margin-left: 15px;">{{item.evaluation.description}}</view>
      <view class="tupian" style="margin-bottom: 20rpx">
