          ...
          <u-row>
            <u-col span="4">
              <view class="price-card">
                <u-text size="22" color="white" background-color="white" :text="'start with ' + minPrice + '￥'"></u-text>
              </view>
            </u-col>
            <u-col span="2">
            </u-col>
              ...
              <u-row>
                ...
                <u-col>
                  <view class="pingfen" style="display: flex;">
                    <start :count="4" :disabled="true" :disabledColor="'orange'" active-color="#eaa12e" size="18" v-model="item.rate"></start>
...
export default {
  ...
  methods: {
    ...
    async getFacility() {
      await getFacilityByTagName(this.activityTag).then(res => {
        this.facility = res.data.facility;
        this.facility.forEach(item => {
          item.facility.images = this.processImages(item.facility.images);
        })
