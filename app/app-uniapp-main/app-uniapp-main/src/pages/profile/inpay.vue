<template>
  <view class="order-list">
    <u-list v-if="!isLoading && orders.length != 0">
      <u-list-item v-for="(item, index) in orders" :key="index" :arrow="true" hight="200">
        <OrderCard :order="item"></OrderCard>
      </u-list-item>
    </u-list>
    <view v-if="isLoading" class="loading">
      <!-- <u-loading size="30" color="#309286"></u-loading> -->
    </view>
    <view v-if="!isLoading && orders.length == 0" class="loading">
      <view style="margin:auto;">No Order</view>
    </view>
