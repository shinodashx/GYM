                ...
                <form>
                  <Grid container spacing={4}>
                    ...
                    <Grid item xs={12}>
                      ...
                      <TextField
                        label={order.orders[0].order.startTime.slice(0,10)}
                        variant="outlined"
                        name={'day'}
                        type={'text'}
                        fullWidth
                    ...
                    <Grid item xs={12}>
                      ...
                      <TextField
                        label={order.orders[0].order.startTime.slice(10,)}
                        variant="outlined"
                        name={'endtime'}
                        type={'text'}
                        fullWidth
                    ...
                    <Grid item xs={12}>
                      ...
                      <TextField
                        label={order.orders[0].order.endTime.slice(10,)}
                        variant="outlined"
                        name={'endtime'}
                        type={'text'}
                        fullWidth
